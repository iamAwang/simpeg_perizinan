    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header" style="background-color: #17a2b8">
                <h3 class="card-title" style="color: white">Leave Permission</h3>
                        ...
                        <td>
                            <div class="btn-group">
                                ...
                                >
                                    ...
                                    <a href="/edit_leave/{{$permission->id}}" style="color: white"
                                        >Edit</a
                                    >
                                </span>
                                <form action="/cancel/leave/{{$permission->id}}" method="post">
                                    @csrf
                                <button
                                    type="submit"
